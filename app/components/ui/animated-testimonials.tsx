      ...
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-[1fr_1.5fr]">
        <div>
          ...
          >
            {testimonials[active].tags.map((tag, index) => (
              <span
                key={index}
                className="text-[13px] px-3 py-0.5 rounded-full bg-gray-100 text-gray-600 dark:bg-neutral-800 dark:text-neutral-300"
              >
                {tag}
              </span>
            ))}
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          >
            ...
            <motion.p className="mt-8 text-lg leading-relaxed text-gray-500 dark:text-neutral-300">
